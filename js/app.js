...
const INLINE_PORTFOLIO_DATA = {
  ...
  background: {
    ...
    paragraphs: [
      "I'm pursuing a Bachelor of Technology in Computer Science and Information Technology, currently in my second year. My focus right now spans five areas at once: Python as my primary language, Java fundamentals, full-stack web development, database design, and an early but deliberate start in machine learning.",
